      ...
      <div className="bg-light">
        <Container className="py-5 bg-light">
            ...
            <Col md={6}>
              <Card className="shadow-sm p-3 border-0">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    AI enables machines to think, learn, and solve problems like humans using machine learning and deep
            ...
            <Col md={6}>
              <Card className="shadow-sm p-3 border-0">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    AI processes vast amounts of data to recognize patterns and make intelligent decisions, improving
                    over time.
                  </Card.Text>
                </Card.Body>
              </Card>
            ...
            <Col md={4}>
              <Card className="shadow-sm p-3 border-0">
                <Card.Body>
                  ...
                  <Card.Text>
                    AI is transforming healthcare with predictive diagnostics, robotic surgeries, and personalized
                    treatments.
                  </Card.Text>
                </Card.Body>
              </Card>
            ...
            <Col md={4}>
              <Card className="shadow-sm p-3 border-0">
                <Card.Body>
                  ...
                  <Card.Text>
                    From automation to data analysis, AI is revolutionizing the business world by improving efficiency
                    and decision-making.
                  </Card.Text>
                </Card.Body>
              </Card>
            ...
            <Col md={4}>
              <Card className="shadow-sm p-3 border-0">
                <Card.Body>
                  ...
                  <Card.Text>
                    Access powerful AI tools like TensorFlow, PyTorch, and OpenAI API for building intelligent
                    applications.
                  </Card.Text>
            ...
            <Col md={4}>
              <Card className="shadow-sm p-3 border-0">
                <Card.Body>
                  ...
                  <Card.Text>
                    Learn the fundamentals of machine learning and data science from top platforms like Coursera and
                    Udemy.
                  </Card.Text>
          ...
          <Row>
            <Col>
              <p className="text-muted text-center fs-5">
                AI is revolutionizing the world! Businesses, marketers, and developers can leverage AI for efficiency
                and growth. Don't miss out on AI-driven opportunities.
              </p>
