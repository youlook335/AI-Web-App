                ...
                <Container className="py-5 bg-light">
                        ...
                        <Col md={4}>
                            <Card className="shadow-sm p-3">
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        Our AI chatbot understands natural language and responds intelligently.
                                    </Card.Text>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md={4}>
                            <Card className="shadow-sm p-3">
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        We use machine learning to provide tailored suggestions for users.
                                    </Card.Text>
                                </Card.Body>
                            </Card>
                        </Col>
                    ...
                    <div className="row mt-5 mb-5 text-center">
                        <div className="col-md-12">
                            <h4 className="fw-bold text-dark">Experience Our AI in Action!</h4>
                            <p className="text-muted">Try our AI-powered chatbot to see how it works.</p>
                    ...
                    <Row className="mb-4">
                        <Col md={8} className="mx-auto">
                            <Card className="p-4 shadow-sm text-center">
                                <Card.Body>
                                    <Card.Title>Try Our AI Chat</Card.Title>
                                    <Form>
                                        <Form.Group controlId="userQuery">
                                            <Form.Control type="text" placeholder="Ask our AI a question!" />
                                        </Form.Group>
