  ...
  return (
    <Card className="text-dark bg-light shadow-lg rounded-4 p-4 text-center border border-primary">
      ...
      <Card.Body>
        ...
        <Button variant="primary" className="rounded-pill px-4 py-2">{buttonText}</Button>
      </Card.Body>
    </Card>
  );
}
  ...
  return (
    <div className="container py-5 bg-light">
      ...
      <div className="text-center mt-5">
        <Button variant="outline-primary" className="rounded-pill px-4 py-2">Your Own Offer</Button>
      </div>
    </div>
  );
}
