    ...
    <>
      ...
      <Row>
        <Col md={6} className="info-box">
          <div className="icon-container"><FaGlobe className="icon-large" /></div>
          <h2>Our Vision</h2>
          <p>
        ...
        <Col md={6} className="info-box">
          <div className="icon-container"><FaBullseye className="icon-large" /></div>
          <h2>Our Mission</h2>
          <p>
      ...
      <Row className="mt-4">
        <Col md={6} className="info-box">
          <div className="icon-container"><FaLightbulb className="icon-large" /></div>
          <h2>Innovation & AI</h2>
          <p>
        ...
        <Col md={6} className="info-box">
          <div className="icon-container"><FaRobot className="icon-large" /></div>
          <h2>Future of AI</h2>
          <p>
